...
export default function App() {
 ...
 const [darkMode, setDarkMode] = useState(false); // ✅ FIXED: Added dark mode state
 const authed = !!token;
 ...
 async function deleteAccount() {
   // Step 1 — Strong warning before deletion
   const confirmDelete = window.confirm(
    ...
    if (!confirmDelete) {
     return; // stop here if the user cancels
   }
   ...
   if (!password) {
    ...
    // Step 3 — API call to delete the account
   try {
     await api.post(
       "/delete",
       { password },
         ...
         {page === "home" && (
           <section className="home-section">
             <div className="home-content">
               <h2>Welcome to <span>ATS for Candidates</span></h2>
               <p>
                 Your all-in-one platform to manage job applications, resumes, and
                 professional profiles — built to make your career journey easier.
               </p>
               <p className="coming-soon">
                 🚀 Exciting new updates and features are coming soon — stay tuned!
               </p>
             </div>
           </section>
         )}
      ...
      {profile && (
        <>
          ...
          <div className="profile-box">
            ...
            />
            <p className="char-count">{profile.bio?.length || 0}/500</p>
                ...
                {employment.map((job) => (
                  <li key={job.id} className="employment-item">
                    ...
                    <small>
                      ...
                      {job.start_date} –{" "}
                      {job.current ? "Present" : job.end_date || "N/A"}
                    </small>
